            ...
            <form role="form" method="Post" action="{{url('adminView/excess_budget')}}">
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="excess" name="excess" value="{{$data->excess}}" placeholder="Excess">
                </div>
                <div class="form-group">
                  <label for="surrender">Surrender</label>
                  <input type="text" class="form-control" id="surrender" name="surrender" value="{{$data->surrender}}" placeholder="Surrender">
                </div>
                <div class="form-group">
                  <label for="reallocation">Reallocation</label>
                  <input type="text" class="form-control" id="reallocation" value="{{$data->reallocation}}" name="reallocation" placeholder="Reallocation">
                </div>
              </div><!-- /.box-body -->
